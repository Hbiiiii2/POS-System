    ...
    <div class="px-6 pt-6 pb-4">
        <header class="flex justify-between items-start mb-4">
            <div class="flex items-center space-x-3">
                <div class="flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 shadow-lg group-hover:shadow-xl transition-all duration-300">
                ...
                <div>
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-200">Products</h2>
            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                ...
                >
                    <ul>
                        <li>
                            <a class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 flex py-2 px-3 transition-colors duration-200" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">View All</a>
                        </li>
                        <li>
                            <a class="font-medium text-sm text-gray-600 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 flex py-2 px-3 transition-colors duration-200" href="#0" @click="open = false" @focus="open = true" @focusout="open = false">Add New</a>
                        </li>
                        <li>
        ...
        <div class="flex items-end justify-between">
            <div class="flex items-baseline space-x-2">
                <div class="text-3xl font-bold text-gray-900 dark:text-white">{{ number_format($dataFeed->sumDataSet(3, 1)) }}</div>
            ...
            <div class="text-right">
                ...
                <div class="text-lg font-semibold text-gray-900 dark:text-white">{{ number_format($dataFeed->sumDataSet(3, 1) - 3) }}</div>
            </div>
        </div>
    </div>
