        ...
        <div class="mb-8">
            <div class="flex flex-wrap items-center justify-between">
                <div class="flex items-center">
                    <h1 class="text-2xl md:text-3xl text-slate-800 dark:text-slate-100 font-bold">Edit Produk</h1>
                </div>
                        ...
                        <form action="{{ route('products.update', $product) }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input id="product_code" class="form-input w-full" type="text" name="product_code" value="{{ old('product_code', $product->product_code) }}" required />
                                    @error('product_code')
                                ...
                                <div>
                                    ...
                                    <input id="name" class="form-input w-full" type="text" name="name" value="{{ old('name', $product->name) }}" required />
                                    @error('name')
                                        <div class="text-xs mt-1 text-rose-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input id="stock" class="form-input w-full" type="number" name="stock" value="{{ old('stock', $product->stock) }}" min="0" required />
                                    @error('stock')
                                        <div class="text-xs mt-1 text-rose-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input id="price" class="form-input w-full" type="number" name="price" value="{{ old('price', $product->price) }}" min="0" step="0.01" required />
                                    @error('price')
                                        <div class="text-xs mt-1 text-rose-500">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div>
                                    ...
                                    <input id="unit" class="form-input w-full" type="text" name="unit" value="{{ old('unit', $product->unit) }}" placeholder="pcs, kg, liter, dll" required />
                                    @error('unit')
                                        <div class="text-xs mt-1 text-rose-500">{{ $message }}</div>
                                    @enderror
                                </div>
